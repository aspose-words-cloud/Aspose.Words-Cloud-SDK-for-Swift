...
dependencies: [
    ...
    .package(url: "https://github.com/aspose-words-cloud/aspose-words-cloud-swift.git", from: "26.1")
],
targets: [
...
```ruby
pod 'AsposeWordsCloud', :git => 'https://github.com/aspose-words-cloud/aspose-words-cloud-swift.git', :tag => '26.1'
```
