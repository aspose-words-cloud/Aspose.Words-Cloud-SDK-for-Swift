...
dependencies: [
    ...
    .package(url: "https://github.com/aspose-words-cloud/aspose-words-cloud-swift.git", from: "25.11")
],
targets: [
...
```ruby
pod 'AsposeWordsCloud', :git => 'https://github.com/aspose-words-cloud/aspose-words-cloud-swift.git', :tag => '25.11'
```
